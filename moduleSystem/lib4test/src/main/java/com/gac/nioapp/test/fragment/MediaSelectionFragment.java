...
import com.gac.nioapp.test.utils.UIUtils;
import com.gac.nioapp.test.widget.MediaGridInset;
...
public class MediaSelectionFragment extends Fragment implements
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        CustomMatisseActivity activity = (CustomMatisseActivity) getActivity();
        if(activity != null)
            activity.updateBottomToolbar();

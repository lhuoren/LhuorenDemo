...
import com.gac.nioapp.test.activity.CustomMatisseActivity;
import com.gac.nioapp.test.bean.CaptureStrategy;
import com.gac.nioapp.test.bean.Filter;
...
public final class SelectionCreator {
     ...
     * 1. com.tanwan.matisse.R.style.Matisse_Zhihu;
     * 2. com.tanwan.matisse.R.style.Matisse_Dracula
     * you can define a custom theme derived from the above ones or other themes.
     *
     * @param themeId theme resource id. Default value is com.tanwan.matisse.R.style.Matisse_Zhihu.
     * @return {@link SelectionCreator} for fluent API.
     */
    ...
    /**
     * 是否显示勾选图标,默认显示.应用在单选下
     *
     * @param showCheckView
     * @return
     */
    public SelectionCreator showCheckView(boolean showCheckView) {
        mSelectionSpec.showCheckView = showCheckView;
        return this;
    }

    public SelectionCreator videoAutoPlay(boolean videoAutoPlay) {
        mSelectionSpec.videoAutoPlay = videoAutoPlay;
        return this;
    }
    ...
    public SelectionCreator onlyTakePicture(boolean onlyTakePicture) {
        mSelectionSpec.onlyTakePicture = onlyTakePicture;
        return this;
    }
    ...
    /**
     * video min duration expand.
     *
     * @param minVideoDuration
     * @return
     */
    public SelectionCreator minVideoDuration(long minVideoDuration) {
        if (minVideoDuration < 0) throw new IllegalArgumentException("videoDuration cannot be less than 0");
        mSelectionSpec.minVideoDuration = minVideoDuration;
        return this;
    }

    /**
     * video max duration expand.
     *
     * @param maxVideoDuration
     * @return
     */
    public SelectionCreator maxVideoDuration(long maxVideoDuration) {
        if (maxVideoDuration < 0) throw new IllegalArgumentException("videoDuration cannot be less than 0");
        mSelectionSpec.maxVideoDuration = maxVideoDuration;
        return this;
    }
     ...
     * @return
     */
    public SelectionCreator maxVideoFileSize(long maxVideoFileSize) {
        if (maxVideoFileSize < 0) throw new IllegalArgumentException("maxVideoFileSize cannot be less than 0");
        mSelectionSpec.maxVideoFileSize = maxVideoFileSize;
        return this;
    }
     ...
     * @return
     */
    public SelectionCreator selectedList(List<Uri> selectedList) {
        if (selectedList == null) throw new IllegalArgumentException("selectedList cannot be null");
        mSelectionSpec.selectedList = selectedList;
        return this;
    }
    ...
    public SelectionCreator selectionListener(SelectionSpec.SelectionListener listener) {
        mSelectionSpec.selectionListener = listener;
        return this;
    }
    ...
    public void forResult(int requestCode) {
        ...
        Intent intent = new Intent(activity, CustomMatisseActivity.class);
    ...
    public void start(Intent nextIntent) {
        Activity activity = mMatisse.getActivity();
        if (activity == null) {
            return;
        }
        ...
        //Intent intent = new Intent(activity, MatisseActivity.class);
        Intent intent = new Intent(activity, CustomMatisseActivity.class);
        intent.putExtra(CustomMatisseActivity.EXTRA_NEXT_INTENT, nextIntent);

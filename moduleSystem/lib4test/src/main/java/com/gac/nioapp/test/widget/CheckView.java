...
public class CheckView extends View {
    ...
    private static final float STROKE_WIDTH = 2.4f; // dp
    private static final float SHADOW_WIDTH = 4.8f; // dp
    private static final int SIZE = 38; // dp
    private static final float STROKE_RADIUS = 9f; // dp
    private static final float BG_RADIUS = 8.6f; // dp
    private static final int CONTENT_SIZE = 13; // dp
    ...
    private Drawable mCheckDrawable,mSelectedDrawable;
    ...
    private void init(Context context) {
       ...
       /* mCheckDrawable = ResourcesCompat.getDrawable(context.getResources(),
        ...
        mCheckDrawable = ResourcesCompat.getDrawable(context.getResources(),
                R.drawable.ic_release_choose_normal, context.getTheme());
        mSelectedDrawable = ResourcesCompat.getDrawable(context.getResources(),
                R.drawable.ic_vedio_choose_click, context.getTheme());
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mCountable) {
            if (mCheckedNum != UNCHECKED) {
                ...
                mCheckDrawable.setBounds(getNoPaddingCheckRect());
            ...
            if (mChecked) {
               ...
               /* initShadowPaint();
                ...
                mSelectedDrawable.setBounds(getNoPaddingCheckRect());
    ...
    private void initTextPaint() {
        if (mTextPaint == null) {
            ...
            mTextPaint.setTextSize(11.0f * mDensity);
        }
    }
    ...
    private Rect getNoPaddingCheckRect() {
        if (mCheckRect == null) {
            int rectPadding = (int) (SIZE * mDensity / 2 - (CONTENT_SIZE + 8) * mDensity / 2);
            mCheckRect = new Rect(rectPadding, rectPadding,
                    (int) (SIZE * mDensity - rectPadding ), (int) (SIZE * mDensity - rectPadding ));
        }

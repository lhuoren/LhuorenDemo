...
public final class SelectionSpec {
    ...
    public boolean onlyTakePicture;
    ...
    public boolean showCheckView = true;
    public boolean videoAutoPlay = false;
    public List<Uri> selectedList;
    ...
    private void reset() {
        ...
        filters = null;
        capture = false;
        onlyTakePicture = false;
        captureStrategy = null;
        spanCount = 3;
        gridExpectedSize = 0;
        minVideoDuration = 0;
        maxVideoDuration = Integer.MAX_VALUE;
        maxVideoFileSize = Integer.MAX_VALUE;
    ...
    public interface SelectionListener {
        void event(EventType eventType, Bundle bundle, Context context);
    }

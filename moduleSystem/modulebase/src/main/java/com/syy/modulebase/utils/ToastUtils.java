...
public class ToastUtils {
    ...
    private static void showMessage(Pair<TextView, String> msg) {
        if (msg != null) {
            if (msg.first == null) {
                Toast.makeText(BaseApplication.getInstanceContext(), "tv is null", Toast.LENGTH_SHORT).show();
            } else {
    ...
    public static void showToast(String msg) {
        Toast.makeText(BaseApplication.getInstanceContext(), msg, Toast.LENGTH_SHORT).show();
    }

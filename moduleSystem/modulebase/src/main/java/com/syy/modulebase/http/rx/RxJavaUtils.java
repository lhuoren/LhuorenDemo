...
public class RxJavaUtils {
    ...
    public static Observable<Long> observableTimeDelay(int seconds) {
        return Observable.just(0L).delay(seconds, TimeUnit.SECONDS).compose(RxJavaUtils.<Long>observableSchedulers());
    }
    public static Observable<Long> observableTimeDelay(int time, TimeUnit unit) {
        return Observable.just(0L).delay(time, unit).compose(RxJavaUtils.<Long>observableSchedulers());
    }
    /**

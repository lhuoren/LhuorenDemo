...
@Entity
public class ChannelAirTaskBean implements Serializable {
    private static final long serialVersionUID = 156231455229546213L;
    ...
    @Convert(columnType = String.class, converter = ChannelDataBeanConverter.class)
    private List<ChannelDataBean> waypoint;
    private Date createDate;
    @Generated(hash = 472796533)
    public ChannelAirTaskBean(Long id, int missiontype, String airLineTaskId,
            ...
            double rectifyAlt, List<ChannelDataBean> waypoint, Date createDate) {
        this.id = id;
    ...
    @Generated(hash = 444680955)
    public ChannelAirTaskBean() {
    }
    public Long getId() {
        return this.id;
    }
    ...
    public List<ChannelDataBean> getWaypoint() {
        return this.waypoint;
    }
    public void setWaypoint(List<ChannelDataBean> waypoint) {
        this.waypoint = waypoint;
    }

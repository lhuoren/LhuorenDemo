...
import com.syy.moduledbbase.DBManagerDownLoadDB;
...
public class DownLoadFlyRecordDaoUtil {

    private FlyRecordDao flyRecordDao;

    public DownLoadFlyRecordDaoUtil() throws Exception {
        flyRecordDao = DBManagerDownLoadDB.getInstance().getDaoSession().getFlyRecordDao();
    }

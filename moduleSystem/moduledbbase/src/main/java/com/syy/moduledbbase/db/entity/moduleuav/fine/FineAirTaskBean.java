...
@Entity
public class FineAirTaskBean implements Serializable {

    private static final long serialVersionUID = 156749965229546213L;
    ...
    @Convert(columnType = String.class, converter = FineDataBeanConverter.class)
    private List<FineDataBean> waypoint;
    private Date createDate;
    @Generated(hash = 1615206071)
    public FineAirTaskBean(Long id, int missiontype, String airLineTaskId,
            ...
            double rectifyLatitude, double rectifyLongitude, double rectifyAlt,
            List<FineDataBean> waypoint, Date createDate) {
        this.id = id;
    ...
    @Generated(hash = 1627110683)
    public FineAirTaskBean() {
    }
    public Long getId() {
        return this.id;
    }
    ...
    public List<FineDataBean> getWaypoint() {
        return this.waypoint;
    }
    public void setWaypoint(List<FineDataBean> waypoint) {
        this.waypoint = waypoint;
    }

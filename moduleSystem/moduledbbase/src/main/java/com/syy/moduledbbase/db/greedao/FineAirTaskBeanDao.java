...
import com.syy.moduledbbase.db.entity.moduleuav.fine.FineDataBeanConverter;
...
/** 
 * DAO for table "FINE_AIR_TASK_BEAN".
*/
public class FineAirTaskBeanDao extends AbstractDao<FineAirTaskBean, Long> {

    public static final String TABLENAME = "FINE_AIR_TASK_BEAN";

    /**
     * Properties of entity FineAirTaskBean.<br/>
    ...
    public static class Properties {
        ...
        public final static Property RectifyLatitude = new Property(11, double.class, "rectifyLatitude", false, "RECTIFY_LATITUDE");
        public final static Property RectifyLongitude = new Property(12, double.class, "rectifyLongitude", false, "RECTIFY_LONGITUDE");
        public final static Property RectifyAlt = new Property(13, double.class, "rectifyAlt", false, "RECTIFY_ALT");
        public final static Property Waypoint = new Property(14, String.class, "waypoint", false, "WAYPOINT");
        public final static Property CreateDate = new Property(15, java.util.Date.class, "createDate", false, "CREATE_DATE");
    }

    private final FineDataBeanConverter waypointConverter = new FineDataBeanConverter();

    public FineAirTaskBeanDao(DaoConfig config) {
        super(config);
    }
    
    public FineAirTaskBeanDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"FINE_AIR_TASK_BEAN\" (" + //
                ...
                "\"RECTIFY_LATITUDE\" REAL NOT NULL ," + // 11: rectifyLatitude
                "\"RECTIFY_LONGITUDE\" REAL NOT NULL ," + // 12: rectifyLongitude
                "\"RECTIFY_ALT\" REAL NOT NULL ," + // 13: rectifyAlt
                "\"WAYPOINT\" TEXT," + // 14: waypoint
                "\"CREATE_DATE\" INTEGER);"); // 15: createDate
    }

    /** Drops the underlying database table. */
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"FINE_AIR_TASK_BEAN\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, FineAirTaskBean entity) {
        stmt.clearBindings();
        ...
        stmt.bindDouble(12, entity.getRectifyLatitude());
        stmt.bindDouble(13, entity.getRectifyLongitude());
        stmt.bindDouble(14, entity.getRectifyAlt());
 
        List waypoint = entity.getWaypoint();
        if (waypoint != null) {
            stmt.bindString(15, waypointConverter.convertToDatabaseValue(waypoint));
        }
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, FineAirTaskBean entity) {
        stmt.clearBindings();
    ...
    @Override
    public FineAirTaskBean readEntity(Cursor cursor, int offset) {
        FineAirTaskBean entity = new FineAirTaskBean( //
            ...
            cursor.getDouble(offset + 11), // rectifyLatitude
            cursor.getDouble(offset + 12), // rectifyLongitude
            cursor.getDouble(offset + 13), // rectifyAlt
            cursor.isNull(offset + 14) ? null : waypointConverter.convertToEntityProperty(cursor.getString(offset + 14)), // waypoint
    ...
    @Override
    public void readEntity(Cursor cursor, FineAirTaskBean entity, int offset) {
        ...
        entity.setRectifyLatitude(cursor.getDouble(offset + 11));
        entity.setRectifyLongitude(cursor.getDouble(offset + 12));
        entity.setRectifyAlt(cursor.getDouble(offset + 13));
        entity.setWaypoint(cursor.isNull(offset + 14) ? null : waypointConverter.convertToEntityProperty(cursor.getString(offset + 14)));
        entity.setCreateDate(cursor.isNull(offset + 15) ? null : new java.util.Date(cursor.getLong(offset + 15)));
     }
    
    @Override
    protected final Long updateKeyAfterInsert(FineAirTaskBean entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(FineAirTaskBean entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(FineAirTaskBean entity) {

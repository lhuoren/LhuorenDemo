...
import com.syy.moduledbbase.db.entity.moduleuav.channel.ChannelDataBeanConverter;
...
/** 
 * DAO for table "CHANNEL_AIR_TASK_BEAN".
*/
public class ChannelAirTaskBeanDao extends AbstractDao<ChannelAirTaskBean, Long> {

    public static final String TABLENAME = "CHANNEL_AIR_TASK_BEAN";

    /**
     * Properties of entity ChannelAirTaskBean.<br/>
    ...
    private final ChannelDataBeanConverter waypointConverter = new ChannelDataBeanConverter();

    public ChannelAirTaskBeanDao(DaoConfig config) {
        super(config);
    }
    
    public ChannelAirTaskBeanDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"CHANNEL_AIR_TASK_BEAN\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"CHANNEL_AIR_TASK_BEAN\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, ChannelAirTaskBean entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, ChannelAirTaskBean entity) {
        stmt.clearBindings();
    ...
    @Override
    public ChannelAirTaskBean readEntity(Cursor cursor, int offset) {
        ChannelAirTaskBean entity = new ChannelAirTaskBean( //
    ...
    @Override
    public void readEntity(Cursor cursor, ChannelAirTaskBean entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(ChannelAirTaskBean entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(ChannelAirTaskBean entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(ChannelAirTaskBean entity) {

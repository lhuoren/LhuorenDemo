...
import com.syy.moduledbbase.db.entity.moduleuav.panorama.PanoramaDataBeanConverter;
...
/** 
 * DAO for table "PANORAMA_AIR_TASK_BEAN".
*/
public class PanoramaAirTaskBeanDao extends AbstractDao<PanoramaAirTaskBean, Long> {

    public static final String TABLENAME = "PANORAMA_AIR_TASK_BEAN";

    /**
     * Properties of entity PanoramaAirTaskBean.<br/>
    ...
    private final PanoramaDataBeanConverter waypointConverter = new PanoramaDataBeanConverter();

    public PanoramaAirTaskBeanDao(DaoConfig config) {
        super(config);
    }
    
    public PanoramaAirTaskBeanDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"PANORAMA_AIR_TASK_BEAN\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"PANORAMA_AIR_TASK_BEAN\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, PanoramaAirTaskBean entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, PanoramaAirTaskBean entity) {
        stmt.clearBindings();
    ...
    @Override
    public PanoramaAirTaskBean readEntity(Cursor cursor, int offset) {
        PanoramaAirTaskBean entity = new PanoramaAirTaskBean( //
    ...
    @Override
    public void readEntity(Cursor cursor, PanoramaAirTaskBean entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(PanoramaAirTaskBean entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(PanoramaAirTaskBean entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(PanoramaAirTaskBean entity) {

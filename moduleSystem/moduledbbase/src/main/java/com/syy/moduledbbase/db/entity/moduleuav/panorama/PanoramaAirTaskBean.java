...
@Entity
public class PanoramaAirTaskBean implements Serializable {
    ...
    @Convert(columnType = String.class, converter = PanoramaDataBeanConverter.class)
    private List<PanoramaDataBean> waypoint;
    private Date createDate;
    @Generated(hash = 1968157938)
    public PanoramaAirTaskBean(Long id, int missiontype, String airLineTaskId,
            ...
            double rectifyAlt, List<PanoramaDataBean> waypoint, Date createDate) {
        this.id = id;
    ...
    @Generated(hash = 1837623903)
    public PanoramaAirTaskBean() {
    }
    public Long getId() {
        return this.id;
    }
    ...
    public List<PanoramaDataBean> getWaypoint() {
        return this.waypoint;
    }
    public void setWaypoint(List<PanoramaDataBean> waypoint) {
        this.waypoint = waypoint;
    }

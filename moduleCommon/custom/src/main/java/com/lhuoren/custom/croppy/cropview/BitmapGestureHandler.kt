...
class BitmapGestureHandler(
    ...
    private val singleTapListener = object : GestureDetector.SimpleOnGestureListener() {
        override fun onSingleTapConfirmed(event: MotionEvent): Boolean {
            event.let { bitmapGestureListener.onSingleTap(it) }
            return true
        }
    }
    ...
    private val singleTapDetector = GestureDetector(context, singleTapListener)
    ...
    fun onTouchEvent(motionEvent: MotionEvent) :Boolean {
        ...
        val singleTap = singleTapDetector.onTouchEvent(motionEvent)
        ...
        return scale || scroll || doubleTap || singleTap
